...
namespace Error {
	...
	//îøèáêè äîäåëàòü : äóáëèğîâàíèå èäåíòèôèêàòîğà, ïğåâûøåíèå äëèíû èëè ğàçìåğà òàáëèö
	ERROR errors[ERROR_MAX_ENTRY] =
	{
		ERROR_ENTRY(0, "Íåäîïóñòèìûé êîä îøìèáêè"),
		ERROR_ENTRY(1, "Ñèñòåìíûé ñáîé"),
		ERROR_ENTRY(2, "Ïğåâûøåíèå ğàçìåğà òàáëèöû ëåêñåì"),
		ERROR_ENTRY(3, "Ïğåâûøåíèå ğàçìåğà òàáëèöû èäåíòèôèêàòîğîâ"), ERROR_ENTRY_NODEF(4), ERROR_ENTRY_NODEF(5),
		...
		ERROR_ENTRY(105, "Ëåêñè÷åñêèé àíàëèçàòîğ: Íåäîïóñòèìàÿ êîíñòğóêöèÿ â ÿçûêå"),
		ERROR_ENTRY(106, "Ïîïûòêà ïîëó÷èòü íåñóùåñòâóşùèé èäåíòèôèêàòîğ"),
		ERROR_ENTRY(107, "Äóáëèğîâàíèå èäåíòèôèêàòîğà"),
